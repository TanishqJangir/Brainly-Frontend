...
export const Signup = () => {
    ...
    return <div className="flex w-screen h-screen justify-center items-center bg-gray-300">
        ...
        <div className="bg-white rounded-xl min-w-48 flex flex-col gap-3 p-8 shadow-2xl">
            ...
            <Button varient="primary" size="md" text="Signup" loading={loading} onClick={handleSignup}/>

            <div className="text-gray-400 text-xs">Already have a account : <a href="http://www.localhost:5173/signin" className="text-primary underline">Signin</a></div>
        </div>
